...
/// Represents a logical event in the operations scene.
#[must_use = "Process the operations event"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub(in crate::tui) enum OperationsEvent {
    /// Do something related to the operations list.
    ListEvent(VerticalListEvent),
    /// Navigate back to the explorer scene.
    Explorer,
    /// Quit the application.
    Quit,
}

impl OperationsEvent {
